...
**MiroThinker**: A deep research agent optimized for research and prediction, achieving a 88.2% on the challenging BrowseComp benchmark. See [Quick Start](#-quick-start).
